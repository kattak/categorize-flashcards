...
var DOC = {
//console.log("setting stuff in doc"); //can't do this in here
...
function newCategories() {
  ...
  //show text with ◀ ▶ helpers
  //left category
  $(DOC.cats[0]).children().html('◀ ' + GAME.currentCategories[0].name);
  //right category
  $(DOC.cats[1]).children().html(GAME.currentCategories[1].name + ' ▶');
  if (GAME.currentCategories[0].name == GAME.currentCategories[1].name) {
    console.warn("INVALID CATEGORIES BEE BAWPP")
    debugger;
  }
}
